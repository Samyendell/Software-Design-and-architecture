...
import game.dice.TwoSixSidedDice;
import game.logging.ConsoleLogger;
...
public class Main {
    public static void main(String[] args) {
        Dice dice = new TwoSixSidedDice();
        Player redPlayer = new DefaultPlayer("Red");
        Player bluePlayer = new DefaultPlayer("Blue");
        Logger logger = new ConsoleLogger();

        Game game = new Game(redPlayer, bluePlayer, dice, logger);
        game.start();
    }
}
